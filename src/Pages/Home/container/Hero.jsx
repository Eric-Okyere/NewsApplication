...
import Corousell from "../../../components/Carousell";

const Hero = () => {
  return (
    <section className="container mx-auto flex flex-col px-5 py-[100px]  lg:flex-row">
      <div className="mt-10 lg:w-1/2">
        ...
        <div className="flex flex-col gap-y-2.5 mt-10 lg:mt-6 xl:mt-10 relative">
          ...
          <button className="w-full bg-black text-white font-semibold rounded-lg px-5 py-3 md:absolute md:right-2 md:top-1/2 md:-translate-y-1/2 md:w-fit md:py-2
           hover:bg-blue-600">
            Search
          </button>
        </div>
        <div className="flex mt-4 flex-col lg:flex-row lg:items-start lg:flex-nowrap lg:gap-x-4 lg:mt-7">
          ...
          <ul className="flex flex-wrap gap-x-2.5 gap-y-2.5 mt-3 lg:text-sm xl:text-base">
            <li className="rounded-lg bg-blue-700 bg-opacity-10 px-3 py-1.5 text-blue-500 font-semibold">
              Design
            </li>
            <li className="rounded-lg bg-blue-700 bg-opacity-10 px-3 py-1.5 text-blue-500 font-semibold">
              User Experience
