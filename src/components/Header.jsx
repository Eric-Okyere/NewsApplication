    ...
    <li className="relative group">
      {item.type === "link" ? (
        ...
        <div className="flex flex-col items-center">
          ...
          >
            <ul className="bg-white lg:bg-transparent text-center flex flex-col shadow-lg rounded-lg overflow-hidden">
              {item.items.map((page, index) => (
                <Link
                  key={index}
                  to={page.href}
                  className="hover:bg-gray-400 hover:text-white px-4 py-2 text-black lg:text-black"
                >
                  {page.title}
                </Link>
              ))}
...
const Header = () => {
  ...
  return (
    <section className="sticky top-0 left-0 right-0 z-50 bg-gray-100">
      <header className="container mx-auto px-5 flex justify-between py-4 items-center">
        ...
        >
          <ul className="text-white text-xl items-center gap-y-5 lg:text-black flex flex-col lg:flex-row gap-x-2 font-semibold">
                    ...
                    <ul className="bg-white lg:bg-white text-center flex flex-col shadow-lg rounded-lg overflow-hidden">
                      {userState?.userInfo?.admin && (
                        <button
                          ...
                          type="button"
                          className="hover:bg-gray-400 hover:text-white px-4 py-2 text-white lg:text-black"
                        >
                          Admin Dashboard
                        </button>
                      )}
